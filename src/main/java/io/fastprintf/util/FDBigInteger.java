...
public /*@ spec_bigint_math @*/ final class FDBigInteger {
  ...
  /**
   * Constructs an <code>FDBigInteger</code> from data and padding. The <code>data</code> parameter
   * has the least significant <code>int</code> at the zeroth index. The <code>offset</code>
   * parameter gives the number of zero <code>int</code>s to be inferred below the least significant
   * element of <code>data</code>.
   *
   * @param data An array containing all non-zero <code>int</code>s of the value.
   * @param offset An offset indicating the number of zero <code>int</code>s to pad below the least
   *     significant element of <code>data</code>.
   */
  /*@
  ...
  /**
   * Constructs an <code>FDBigInteger</code> from a starting value and some decimal digits.
   *
  ...
  /**
   * Returns an <code>FDBigInteger</code> with the numerical value <code>
   * 5<sup>p5</sup> * 2<sup>p2</sup></code>.
   *
      ...
      if (p2 == 0) {
        ...
        if (bitcount == 0) {
          ...
          return new FDBigInteger(
              new int[] {pow5 << bitcount, pow5 >>> (32 - bitcount)}, wordcount);
        }
      } else {
  ...
  /**
   * Returns an <code>FDBigInteger</code> with the numerical value <code>
   * value * 5<sup>p5</sup> * 2<sup>p2</sup></code>.
   *
  ...
  public static FDBigInteger valueOfMulPow52(long value, int p5, int p2) {
    ...
    if (p5 != 0) {
      ...
      if (bitcount == 0) {
        ...
        return new FDBigInteger(
            new int[] {
              v0 << bitcount, (v1 << bitcount) | (v0 >>> (32 - bitcount)), v1 >>> (32 - bitcount)
            },
            wordcount);
      }
    }
  ...
  /**
   * Returns an <code>FDBigInteger</code> with the numerical value <code>2<sup>p2</sup></code>.
   *
  ...
  /**
   * Determines whether all elements of an array are zero for all indices less than a given index.
   *
  ...
  /**
   * Multiplies by 10 a big integer represented as an array. The final carry is returned.
   *
  ...
  /**
   * Multiplies by a constant value a big integer represented as an array. The constant factor is an
   * <code>int</code>.
   *
   * @param src The array representation of the big integer.
   * @param srcLen The number of elements of <code>src</code> to use.
  ...
  /**
   * Multiplies by a constant value a big integer represented as an array. The constant factor is a
   * long represent as two <code>int</code>s.
   *
   * @param src The array representation of the big integer.
   * @param srcLen The number of elements of <code>src</code> to use.
  ...
  /**
   * Removes all leading zeros from this <code>FDBigInteger</code> adjusting the offset and number
   * of non-zero leading words accordingly.
   */
  /*@
  @ requires data != null;
  ...
  /**
   * Retrieves the normalization bias of the <code>FDBigIntger</code>. The normalization bias is a
   * left shift such that after it the highest word of the value will have the 4 highest bits equal
   * to zero: {@code (highestWord & 0xf0000000) == 0}, but the next bit should be 1 {@code
  ...
  /**
   * Shifts this <code>FDBigInteger</code> to the left. The shift is performed in-place unless the
   * <code>FDBigInteger</code> is immutable in which case a new instance of <code>FDBigInteger
   * </code> is returned.
   *
   ...
   * </pre>
   *
   * This is the iteration step of digit development for output. We assume that S has been
   * normalized, as above, and that "this" has been left-shifted accordingly. Also assumed, of
   * course, is that the result, q, can be expressed as an integer, {@code 0 <= q < 10}.
   *
  ...
  /**
   * Multiplies this <code>FDBigInteger</code> by 10. The operation will be performed in place
   * unless the <code>FDBigInteger</code> is immutable in which case a new <code>FDBigInteger</code>
   * will be returned.
   *
  ...
  /**
   * Multiplies this <code>FDBigInteger</code> by <code>5<sup>p5</sup> * 2<sup>p2</sup></code>. The
   * operation will be performed in place if possible, otherwise a new <code>FDBigInteger</code>
   * will be returned.
   *
   * @param p5 The exponent of the power-of-five factor.
   * @param p2 The exponent of the power-of-two factor.
   ...
   * . Assert that the result is positive. If the subtrahend is immutable, store the result in
   * this(minuend). If this(minuend) is immutable a new <code>FDBigInteger</code> is created.
   *
  ...
  /**
   * Subtracts the supplied <code>FDBigInteger</code> subtrahend from this <code>FDBigInteger</code>
   * . Assert that the result is positive. If the this(minuend) is immutable, store the result in
   * subtrahend. If subtrahend is immutable a new <code>FDBigInteger</code> is created.
   *
   * @param subtrahend The <code>FDBigInteger</code> to be subtracted.
   * @return This <code>FDBigInteger</code> less the subtrahend.
   */
  ...
  /**
   * Compares the parameter with this <code>FDBigInteger</code>. Returns an integer accordingly as:
   *
   * <pre>{@code
   * > 0: this > other
   *   0: this == other
  ...
  /**
   * Compares this <code>FDBigInteger</code> with <code>5<sup>p5</sup> * 2<sup>p2</sup></code>.
  ...
  /**
   * Compares this <code>FDBigInteger</code> with <code>x + y</code>. Returns a value according to
   * the comparison as:
   *
   * <pre>{@code
   * -1: this <  x + y
  ...
  private FDBigInteger add(FDBigInteger other) {
    ...
    for (; i < smallLen; i++) {
      carry +=
          (i < big.offset ? 0L : (big.data[i - big.offset] & LONG_MASK))
  ...
  /**
   * Multiplies a <code>FDBigInteger</code> by an int and adds another int. The result is computed
   * in place. This method is intended only to be invoked from <code>
   ...
   * @param addend The value to add to the product of this <code>FDBigInteger</code> and <code>iv
   *     </code>.
   */
  /*@
  ...
  /**
   * Multiplies the parameters and subtracts them from this <code>FDBigInteger</code>.
   *

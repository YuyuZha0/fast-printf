...
public final class FormattedFloatingDecimal {
  ...
  public static FormattedFloatingDecimal valueOf(
      double d, int precision, FormattedFloatingDecimal.Form form) {
    FloatingDecimal.BinaryToASCIIConverter fdConverter =
        FloatingDecimal.getBinaryToASCIIConverter(
            d, form == FormattedFloatingDecimal.Form.COMPATIBLE);
  ...
  /**
   * Returns the mantissa as a {@code char[]}. Note that the returned value is a reference to the
   * internal {@code char[]} containing the mantissa, therefore code invoking this method should not
   * pass the return value to external code but should in that case make a copy.
   *
   * @return a reference to the internal {@code char[]} representing the mantissa.
   */
  ...
  /**
   * Returns the exponent as a {@code char[]}. Note that the returned value is a reference to the
   * internal {@code char[]} containing the exponent, therefore code invoking this method should not
   * pass the return value to external code but should in that case make a copy.
   *
   * @return a reference to the internal {@code char[]} representing the exponent.
   */
